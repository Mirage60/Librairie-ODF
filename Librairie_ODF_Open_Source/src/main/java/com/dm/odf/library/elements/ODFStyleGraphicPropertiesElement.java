...
import com.dm.odf.library.interfaces.elements.IODFStyleGraphicPropertiesElement;

public abstract class ODFStyleGraphicPropertiesElement extends ODFElement implements IODFStyleGraphicPropertiesElement
{
	...
	protected ODFStyleGraphicPropertiesElement()
	{
	...
	public final ODF_ELEMENT_ID getElementID()
	{
		...
		return ODF_ELEMENT_ID.STYLE_GRAPHIC_PROPERTIES;
